const translations = {
    "en-US": {
        ...
        "path.target": "Target Node",
        "path.add": "Add Path",
        "path.noPaths": "No paths added",
        "path.selectOne": "Please select exactly one node in the graph first.",
        "path.notFound": "No path found between these nodes.",
        "path.notFound": "No path found between these nodes.",
        "path.duplicate": "Path already exists and is highlighted.",
        "graph.noUnexpanded": "No unexpanded nodes found.",
        "graph.noUnexpandedPass": "No unexpanded nodes found in this pass.",
        "graph.noNewData": "No new data to expand.",
        "graph.expansionFailed": "Expansion failed.",
        "settings.errorLoading": "Error loading settings.",
        "settings.expandNext": "Expand Next Batch",
        "search.failedLoad": "Failed to load nodes",
        "relationsettings.col.relationId": "Relation ID",
        "relationsettings.col.viewGroupId": "View Group ID",
        ...
        "settings.searchTitle": "Search on Graph",
        "settings.searchPlaceholder": "Enter Node ID or Name",
        "settings.addBtn": "Add",
        "settings.showBtn": "Show & Blink",
        "settings.clearBtn": "Clear List",
    ...
    "ar-AE": {
        ...
        "datasource.update": "تحديث",
        "datasource.updating": "جار التحديث...",
        ...
        "path.title": "المسار",
        "path.source": "عقدة المصدر",
        "path.target": "عقدة الهدف",
        "path.add": "إضافة مسار",
        "path.noPaths": "لم تتم إضافة مسارات",
        "path.selectOne": "يرجى تحديد عقدة واحدة بالضبط في الرسم البياني أولاً.",
        "path.notFound": "لم يتم العثور على مسار بين هذه العقد.",
        "path.notFound": "لم يتم العثور على مسار بين هذه العقد.",
        "path.duplicate": "المسار موجود بالفعل وتم تمييزه.",
        "graph.noUnexpanded": "لم يتم العثور على عقد غير موسعة.",
        "graph.noUnexpandedPass": "لم يتم العثور على عقد غير موسعة في هذه التمريرة.",
        "graph.noNewData": "لا توجد بيانات جديدة للتوسيع.",
        ...
        "settings.searchTitle": "بحث في الرسم البياني",
        "settings.searchPlaceholder": "أدخل معرف العقدة أو الاسم",
        "settings.addBtn": "إضافة",
        "settings.showBtn": "عرض وميض",
        "settings.clearBtn": "مسح القائمة",
