USE [IAS]
GO
/****** Object:  Schema [graphdb]    Script Date: 03/12/2025 1:44:57 AM ******/
CREATE SCHEMA [graphdb]
GO
/****** Object:  UserDefinedTableType [graphdb].[NodeDataIDTable]    Script Date: 03/12/2025 1:44:57 AM ******/
...
GO
/****** Object:  UserDefinedTableType [graphdb].[NodeFilterTable]    Script Date: 03/12/2025 1:44:57 AM ******/
...
GO
/****** Object:  Table [graphdb].[Relations]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [graphdb].[Nodes]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[GroupNode]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [graphdb].[vRelations]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[NodeData]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[RelationData]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [graphdb].[vRelationData]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
SELECT RD.RelationDataID, RD.ViewGroupID, RD.SourceNodeDataID, SND.NodeID AS SourceNodeID, SND.NodeValueID AS SourceNodeValueID, SND.NodeValueEn AS SourceNodeValueEn, SND.NodeValueAr AS SourceNodeValueAr, 
                  SND.NodeValueDate AS SourceNodeValueDate, RD.TargetNodeDataID, TND.NodeID AS TargetNodeID, TND.NodeValueID AS TargetNodeValueID, TND.NodeValueEn AS TargetNodeValueEn, TND.NodeValueAr AS TargetNodeValueAr, 
                  TND.NodeValueDate AS TargetNodeValueDate, RD.RelationEn, RD.RelationAr, RD.RelationValueDate
FROM     graphdb.RelationData AS RD INNER JOIN
                  graphdb.NodeData AS SND ON RD.SourceNodeDataID = SND.NodeDataID INNER JOIN
                  graphdb.NodeData AS TND ON RD.TargetNodeDataID = TND.NodeDataID
GO
/****** Object:  Table [graphdb].[IncidentsData]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[RelationsData]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[ViewColumns]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[ViewGroupLists]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[ViewGroups]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[Views]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [graphdb].[GroupNode] ([GroupNodeID], [GroupNodeEn], [GroupNodeAr]) VALUES (1, N'Incident', N'حادثة')
GO
INSERT [graphdb].[GroupNode] ([GroupNodeID], [GroupNodeEn], [GroupNodeAr]) VALUES (2, N'Vehicle', N'عربة')
GO
INSERT [graphdb].[GroupNode] ([GroupNodeID], [GroupNodeEn], [GroupNodeAr]) VALUES (3, N'Person', N'شخص')
GO
INSERT [graphdb].[GroupNode] ([GroupNodeID], [GroupNodeEn], [GroupNodeAr]) VALUES (4, N'Weapon', N'سلاح')
GO
INSERT [graphdb].[IncidentsData] ([ENED_A_ENED], [ARED_A_ARED], [DATE_A_DATE], [ID_A_ID], [ENTEXT_A_ENTEXT], [ARTEXT_A_ARTEXT], [ENED_B_ENED], [ARED_B_ARED], [DATE_B_DATE], [ID_B_ID], [ENTEXT_B_ENTEXT], [ARTEXT_B_ARTEXT], [ENED_C_ENED], [ARED_C_ARED], [DATE_C_DATE], [ID_C_ID], [ENTEXT_C_ENTEXT], [ARTEXT_C_ARTEXT], [ENED_D_ENED], [ARED_D_ARED], [DATE_D_DATE], [ID_D_ID], [ENTEXT_D_ENTEXT], [ARTEXT_D_ARTEXT]) VALUES (NULL, N'Incident', CAST(N'2025-11-14' AS Date), 1, N'Incident 1', NULL, NULL, N'Character', CAST(N'1900-01-01' AS Date), 1, N'Person 1', NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL)
GO
INSERT [graphdb].[IncidentsData] ([ENED_A_ENED], [ARED_A_ARED], [DATE_A_DATE], [ID_A_ID], [ENTEXT_A_ENTEXT], [ARTEXT_A_ARTEXT], [ENED_B_ENED], [ARED_B_ARED], [DATE_B_DATE], [ID_B_ID], [ENTEXT_B_ENTEXT], [ARTEXT_B_ARTEXT], [ENED_C_ENED], [ARED_C_ARED], [DATE_C_DATE], [ID_C_ID], [ENTEXT_C_ENTEXT], [ARTEXT_C_ARTEXT], [ENED_D_ENED], [ARED_D_ARED], [DATE_D_DATE], [ID_D_ID], [ENTEXT_D_ENTEXT], [ARTEXT_D_ARTEXT]) VALUES (NULL, N'Incident', CAST(N'2025-11-14' AS Date), 1, N'Incident 1', NULL, NULL, N'Character', CAST(N'1900-01-01' AS Date), 2, N'Person 2', NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL)
GO
INSERT [graphdb].[IncidentsData] ([ENED_A_ENED], [ARED_A_ARED], [DATE_A_DATE], [ID_A_ID], [ENTEXT_A_ENTEXT], [ARTEXT_A_ARTEXT], [ENED_B_ENED], [ARED_B_ARED], [DATE_B_DATE], [ID_B_ID], [ENTEXT_B_ENTEXT], [ARTEXT_B_ARTEXT], [ENED_C_ENED], [ARED_C_ARED], [DATE_C_DATE], [ID_C_ID], [ENTEXT_C_ENTEXT], [ARTEXT_C_ARTEXT], [ENED_D_ENED], [ARED_D_ARED], [DATE_D_DATE], [ID_D_ID], [ENTEXT_D_ENTEXT], [ARTEXT_D_ARTEXT]) VALUES (NULL, N'Incident', CAST(N'2025-11-14' AS Date), 1, N'Incident 1', NULL, NULL, N'Character', CAST(N'1900-01-01' AS Date), 3, N'Person 3', NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL)
GO
INSERT [graphdb].[IncidentsData] ([ENED_A_ENED], [ARED_A_ARED], [DATE_A_DATE], [ID_A_ID], [ENTEXT_A_ENTEXT], [ARTEXT_A_ARTEXT], [ENED_B_ENED], [ARED_B_ARED], [DATE_B_DATE], [ID_B_ID], [ENTEXT_B_ENTEXT], [ARTEXT_B_ARTEXT], [ENED_C_ENED], [ARED_C_ARED], [DATE_C_DATE], [ID_C_ID], [ENTEXT_C_ENTEXT], [ARTEXT_C_ARTEXT], [ENED_D_ENED], [ARED_D_ARED], [DATE_D_DATE], [ID_D_ID], [ENTEXT_D_ENTEXT], [ARTEXT_D_ARTEXT]) VALUES (NULL, N'Incident', CAST(N'2025-11-14' AS Date), 1, N'Incident 1', NULL, NULL, N'Character', CAST(N'1900-01-01' AS Date), 4, N'Person 4', NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL)
GO
INSERT [graphdb].[IncidentsData] ([ENED_A_ENED], [ARED_A_ARED], [DATE_A_DATE], [ID_A_ID], [ENTEXT_A_ENTEXT], [ARTEXT_A_ARTEXT], [ENED_B_ENED], [ARED_B_ARED], [DATE_B_DATE], [ID_B_ID], [ENTEXT_B_ENTEXT], [ARTEXT_B_ARTEXT], [ENED_C_ENED], [ARED_C_ARED], [DATE_C_DATE], [ID_C_ID], [ENTEXT_C_ENTEXT], [ARTEXT_C_ARTEXT], [ENED_D_ENED], [ARED_D_ARED], [DATE_D_DATE], [ID_D_ID], [ENTEXT_D_ENTEXT], [ARTEXT_D_ARTEXT]) VALUES (NULL, N'Incident', CAST(N'2025-11-14' AS Date), 1, N'Incident 1', NULL, NULL, N'Character', CAST(N'1900-01-01' AS Date), 5, N'Person 5', NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL)
GO
INSERT [graphdb].[IncidentsData] ([ENED_A_ENED], [ARED_A_ARED], [DATE_A_DATE], [ID_A_ID], [ENTEXT_A_ENTEXT], [ARTEXT_A_ARTEXT], [ENED_B_ENED], [ARED_B_ARED], [DATE_B_DATE], [ID_B_ID], [ENTEXT_B_ENTEXT], [ARTEXT_B_ARTEXT], [ENED_C_ENED], [ARED_C_ARED], [DATE_C_DATE], [ID_C_ID], [ENTEXT_C_ENTEXT], [ARTEXT_C_ARTEXT], [ENED_D_ENED], [ARED_D_ARED], [DATE_D_DATE], [ID_D_ID], [ENTEXT_D_ENTEXT], [ARTEXT_D_ARTEXT]) VALUES (NULL, N'Incident', CAST(N'1900-01-01' AS Date), 2, N'Incident 2', NULL, NULL, N'Character', CAST(N'1900-01-01' AS Date), 1, N'Person 1', NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL)
GO
INSERT [graphdb].[IncidentsData] ([ENED_A_ENED], [ARED_A_ARED], [DATE_A_DATE], [ID_A_ID], [ENTEXT_A_ENTEXT], [ARTEXT_A_ARTEXT], [ENED_B_ENED], [ARED_B_ARED], [DATE_B_DATE], [ID_B_ID], [ENTEXT_B_ENTEXT], [ARTEXT_B_ARTEXT], [ENED_C_ENED], [ARED_C_ARED], [DATE_C_DATE], [ID_C_ID], [ENTEXT_C_ENTEXT], [ARTEXT_C_ARTEXT], [ENED_D_ENED], [ARED_D_ARED], [DATE_D_DATE], [ID_D_ID], [ENTEXT_D_ENTEXT], [ARTEXT_D_ARTEXT]) VALUES (NULL, N'Incident', CAST(N'1900-01-01' AS Date), 2, N'Incident 2', NULL, NULL, N'Character', CAST(N'1900-01-01' AS Date), 6, N'Person 6', NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL)
GO
INSERT [graphdb].[IncidentsData] ([ENED_A_ENED], [ARED_A_ARED], [DATE_A_DATE], [ID_A_ID], [ENTEXT_A_ENTEXT], [ARTEXT_A_ARTEXT], [ENED_B_ENED], [ARED_B_ARED], [DATE_B_DATE], [ID_B_ID], [ENTEXT_B_ENTEXT], [ARTEXT_B_ARTEXT], [ENED_C_ENED], [ARED_C_ARED], [DATE_C_DATE], [ID_C_ID], [ENTEXT_C_ENTEXT], [ARTEXT_C_ARTEXT], [ENED_D_ENED], [ARED_D_ARED], [DATE_D_DATE], [ID_D_ID], [ENTEXT_D_ENTEXT], [ARTEXT_D_ARTEXT]) VALUES (NULL, N'Incident', CAST(N'1900-01-01' AS Date), 2, N'Incident 2', NULL, NULL, N'Character', CAST(N'1900-01-01' AS Date), 3, N'Person 3', NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL)
GO
INSERT [graphdb].[IncidentsData] ([ENED_A_ENED], [ARED_A_ARED], [DATE_A_DATE], [ID_A_ID], [ENTEXT_A_ENTEXT], [ARTEXT_A_ARTEXT], [ENED_B_ENED], [ARED_B_ARED], [DATE_B_DATE], [ID_B_ID], [ENTEXT_B_ENTEXT], [ARTEXT_B_ARTEXT], [ENED_C_ENED], [ARED_C_ARED], [DATE_C_DATE], [ID_C_ID], [ENTEXT_C_ENTEXT], [ARTEXT_C_ARTEXT], [ENED_D_ENED], [ARED_D_ARED], [DATE_D_DATE], [ID_D_ID], [ENTEXT_D_ENTEXT], [ARTEXT_D_ARTEXT]) VALUES (NULL, N'Incident', CAST(N'1900-01-01' AS Date), 2, N'Incident 2', NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL, NULL, N'Car', CAST(N'1900-01-01' AS Date), 11, N'Rav 4', NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL)
GO
INSERT [graphdb].[IncidentsData] ([ENED_A_ENED], [ARED_A_ARED], [DATE_A_DATE], [ID_A_ID], [ENTEXT_A_ENTEXT], [ARTEXT_A_ARTEXT], [ENED_B_ENED], [ARED_B_ARED], [DATE_B_DATE], [ID_B_ID], [ENTEXT_B_ENTEXT], [ARTEXT_B_ARTEXT], [ENED_C_ENED], [ARED_C_ARED], [DATE_C_DATE], [ID_C_ID], [ENTEXT_C_ENTEXT], [ARTEXT_C_ARTEXT], [ENED_D_ENED], [ARED_D_ARED], [DATE_D_DATE], [ID_D_ID], [ENTEXT_D_ENTEXT], [ARTEXT_D_ARTEXT]) VALUES (NULL, N'Incident', CAST(N'2025-11-14' AS Date), 1, N'Incident 1', NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL, NULL, N'Car', CAST(N'1900-01-01' AS Date), 12, N'Yaris', NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL)
GO
INSERT [graphdb].[IncidentsData] ([ENED_A_ENED], [ARED_A_ARED], [DATE_A_DATE], [ID_A_ID], [ENTEXT_A_ENTEXT], [ARTEXT_A_ARTEXT], [ENED_B_ENED], [ARED_B_ARED], [DATE_B_DATE], [ID_B_ID], [ENTEXT_B_ENTEXT], [ARTEXT_B_ARTEXT], [ENED_C_ENED], [ARED_C_ARED], [DATE_C_DATE], [ID_C_ID], [ENTEXT_C_ENTEXT], [ARTEXT_C_ARTEXT], [ENED_D_ENED], [ARED_D_ARED], [DATE_D_DATE], [ID_D_ID], [ENTEXT_D_ENTEXT], [ARTEXT_D_ARTEXT]) VALUES (NULL, N'Incident', CAST(N'1900-01-01' AS Date), 2, N'Incident 2', NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL, NULL, N'Car', CAST(N'1900-01-01' AS Date), 13, N'BYD', NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL)
GO
INSERT [graphdb].[IncidentsData] ([ENED_A_ENED], [ARED_A_ARED], [DATE_A_DATE], [ID_A_ID], [ENTEXT_A_ENTEXT], [ARTEXT_A_ARTEXT], [ENED_B_ENED], [ARED_B_ARED], [DATE_B_DATE], [ID_B_ID], [ENTEXT_B_ENTEXT], [ARTEXT_B_ARTEXT], [ENED_C_ENED], [ARED_C_ARED], [DATE_C_DATE], [ID_C_ID], [ENTEXT_C_ENTEXT], [ARTEXT_C_ARTEXT], [ENED_D_ENED], [ARED_D_ARED], [DATE_D_DATE], [ID_D_ID], [ENTEXT_D_ENTEXT], [ARTEXT_D_ARTEXT]) VALUES (NULL, N'Incident', CAST(N'2025-11-14' AS Date), 1, N'Incident 1', NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL, NULL, N'Weapon', CAST(N'1900-01-01' AS Date), 1, N'Weapon 1', NULL)
GO
INSERT [graphdb].[IncidentsData] ([ENED_A_ENED], [ARED_A_ARED], [DATE_A_DATE], [ID_A_ID], [ENTEXT_A_ENTEXT], [ARTEXT_A_ARTEXT], [ENED_B_ENED], [ARED_B_ARED], [DATE_B_DATE], [ID_B_ID], [ENTEXT_B_ENTEXT], [ARTEXT_B_ARTEXT], [ENED_C_ENED], [ARED_C_ARED], [DATE_C_DATE], [ID_C_ID], [ENTEXT_C_ENTEXT], [ARTEXT_C_ARTEXT], [ENED_D_ENED], [ARED_D_ARED], [DATE_D_DATE], [ID_D_ID], [ENTEXT_D_ENTEXT], [ARTEXT_D_ARTEXT]) VALUES (NULL, N'Incident', CAST(N'1900-01-01' AS Date), 2, N'Incident 2', NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL, NULL, NULL, CAST(N'1900-01-01' AS Date), NULL, NULL, NULL, NULL, N'Weapon', CAST(N'1900-01-01' AS Date), 2, N'Weapon 2', NULL)
GO
SET IDENTITY_INSERT [graphdb].[NodeData] ON 
GO
INSERT [graphdb].[NodeData] ([NodeDataID], [ViewGroupID], [NodeID], [NodeValueID], [NodeValueEn], [NodeValueAr], [NodeValueDate]) VALUES (1, 1, 1, N'1', N'Incident 1', N'Incident 1', CAST(N'2025-11-14' AS Date))
GO
INSERT [graphdb].[NodeData] ([NodeDataID], [ViewGroupID], [NodeID], [NodeValueID], [NodeValueEn], [NodeValueAr], [NodeValueDate]) VALUES (2, 1, 1, N'2', N'Incident 2', N'Incident 2', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[NodeData] ([NodeDataID], [ViewGroupID], [NodeID], [NodeValueID], [NodeValueEn], [NodeValueAr], [NodeValueDate]) VALUES (3, 1, 2, N'1', N'Person 1', N'Person 1', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[NodeData] ([NodeDataID], [ViewGroupID], [NodeID], [NodeValueID], [NodeValueEn], [NodeValueAr], [NodeValueDate]) VALUES (4, 1, 2, N'2', N'Person 2', N'Person 2', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[NodeData] ([NodeDataID], [ViewGroupID], [NodeID], [NodeValueID], [NodeValueEn], [NodeValueAr], [NodeValueDate]) VALUES (5, 1, 2, N'3', N'Person 3', N'Person 3', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[NodeData] ([NodeDataID], [ViewGroupID], [NodeID], [NodeValueID], [NodeValueEn], [NodeValueAr], [NodeValueDate]) VALUES (6, 1, 2, N'4', N'Person 4', N'Person 4', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[NodeData] ([NodeDataID], [ViewGroupID], [NodeID], [NodeValueID], [NodeValueEn], [NodeValueAr], [NodeValueDate]) VALUES (7, 1, 2, N'5', N'Person 5', N'Person 5', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[NodeData] ([NodeDataID], [ViewGroupID], [NodeID], [NodeValueID], [NodeValueEn], [NodeValueAr], [NodeValueDate]) VALUES (8, 1, 2, N'6', N'Person 6', N'Person 6', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[NodeData] ([NodeDataID], [ViewGroupID], [NodeID], [NodeValueID], [NodeValueEn], [NodeValueAr], [NodeValueDate]) VALUES (9, 1, 3, N'11', N'Rav 4', N'Rav 4', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[NodeData] ([NodeDataID], [ViewGroupID], [NodeID], [NodeValueID], [NodeValueEn], [NodeValueAr], [NodeValueDate]) VALUES (10, 1, 3, N'12', N'Yaris', N'Yaris', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[NodeData] ([NodeDataID], [ViewGroupID], [NodeID], [NodeValueID], [NodeValueEn], [NodeValueAr], [NodeValueDate]) VALUES (11, 1, 3, N'13', N'BYD', N'BYD', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[NodeData] ([NodeDataID], [ViewGroupID], [NodeID], [NodeValueID], [NodeValueEn], [NodeValueAr], [NodeValueDate]) VALUES (12, 1, 4, N'1', N'Weapon 1', N'Weapon 1', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[NodeData] ([NodeDataID], [ViewGroupID], [NodeID], [NodeValueID], [NodeValueEn], [NodeValueAr], [NodeValueDate]) VALUES (13, 1, 4, N'2', N'Weapon 2', N'Weapon 2', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[NodeData] ([NodeDataID], [ViewGroupID], [NodeID], [NodeValueID], [NodeValueEn], [NodeValueAr], [NodeValueDate]) VALUES (14, 1, 5, N'2', N'Person 2', N'Person 2', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[NodeData] ([NodeDataID], [ViewGroupID], [NodeID], [NodeValueID], [NodeValueEn], [NodeValueAr], [NodeValueDate]) VALUES (15, 1, 5, N'3', N'Person 3', N'Person 3', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[NodeData] ([NodeDataID], [ViewGroupID], [NodeID], [NodeValueID], [NodeValueEn], [NodeValueAr], [NodeValueDate]) VALUES (16, 1, 5, N'5', N'Person 5', N'Person 5', CAST(N'1900-01-01' AS Date))
GO
SET IDENTITY_INSERT [graphdb].[NodeData] OFF
GO
SET IDENTITY_INSERT [graphdb].[Nodes] ON 
GO
INSERT [graphdb].[Nodes] ([NodeID], [GroupNodeID], [ColumnID], [ColumnEn], [ColumnAr], [ColumnColor]) VALUES (1, 1, N'ID_A_ID', N'Incident', N'حادثة', N'#de3f3f')
GO
INSERT [graphdb].[Nodes] ([NodeID], [GroupNodeID], [ColumnID], [ColumnEn], [ColumnAr], [ColumnColor]) VALUES (2, 3, N'ID_B_ID', N'Character', N'شخصية', N'#6552a7')
GO
INSERT [graphdb].[Nodes] ([NodeID], [GroupNodeID], [ColumnID], [ColumnEn], [ColumnAr], [ColumnColor]) VALUES (3, 2, N'ID_C_ID', N'Vehicle', N'عربة', N'#74a24e')
GO
INSERT [graphdb].[Nodes] ([NodeID], [GroupNodeID], [ColumnID], [ColumnEn], [ColumnAr], [ColumnColor]) VALUES (4, 4, N'ID_D_ID', N'Weapon', N'سلاح', N'#9cd265')
GO
INSERT [graphdb].[Nodes] ([NodeID], [GroupNodeID], [ColumnID], [ColumnEn], [ColumnAr], [ColumnColor]) VALUES (5, 3, N'ID_R_ID', N'Relation', N'العلاقة', N'#ffd152')
GO
SET IDENTITY_INSERT [graphdb].[Nodes] OFF
GO
SET IDENTITY_INSERT [graphdb].[RelationData] ON 
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10177, 1, 3, 1, N'Incicent', N'Incicent', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10178, 1, 4, 1, N'Incicent', N'Incicent', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10179, 1, 5, 1, N'Incicent', N'Incicent', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10180, 1, 6, 1, N'Incicent', N'Incicent', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10181, 1, 7, 1, N'Incicent', N'Incicent', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10182, 1, 3, 2, N'Incicent', N'Incicent', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10183, 1, 8, 2, N'Incicent', N'Incicent', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10184, 1, 5, 2, N'Incicent', N'Incicent', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10185, 1, 9, 2, N'Incicent', N'Incicent', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10186, 1, 10, 1, N'Incicent', N'Incicent', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10187, 1, 11, 2, N'Incicent', N'Incicent', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10188, 1, 1, 3, N'Person Involved', N'Person Involved', CAST(N'2025-11-14' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10189, 1, 1, 4, N'Person Involved', N'Person Involved', CAST(N'2025-11-14' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10190, 1, 1, 5, N'Person Involved', N'Person Involved', CAST(N'2025-11-14' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10191, 1, 1, 6, N'Person Involved', N'Person Involved', CAST(N'2025-11-14' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10192, 1, 1, 7, N'Person Involved', N'Person Involved', CAST(N'2025-11-14' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10193, 1, 2, 3, N'Person Involved', N'Person Involved', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10194, 1, 2, 8, N'Person Involved', N'Person Involved', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10195, 1, 2, 5, N'Person Involved', N'Person Involved', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10196, 1, 2, 9, N'Vehicle Used', N'Vehicle Used', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10197, 1, 1, 10, N'Vehicle Used', N'Vehicle Used', CAST(N'2025-11-14' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10198, 1, 2, 11, N'Vehicle Used', N'Vehicle Used', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10199, 1, 1, 12, N'Weapon Used', N'Weapon Used', CAST(N'2025-11-14' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10200, 1, 2, 13, N'Weapon Used', N'Weapon Used', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10201, 1, 3, 14, N'Brother', N'Brother', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10202, 1, 3, 15, N'Sister', N'Sister', CAST(N'1900-01-01' AS Date))
GO
INSERT [graphdb].[RelationData] ([RelationDataID], [ViewGroupID], [SourceNodeDataID], [TargetNodeDataID], [RelationEn], [RelationAr], [RelationValueDate]) VALUES (10203, 1, 6, 16, N'Sister', N'Sister', CAST(N'1900-01-01' AS Date))
GO
SET IDENTITY_INSERT [graphdb].[RelationData] OFF
GO
SET IDENTITY_INSERT [graphdb].[Relations] ON 
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (7, 1, 2, 2, 1, NULL, N'Incicent', N'Incicent', 1)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (13, 1, 3, 3, 1, NULL, N'Incicent', N'Incicent', 1)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (19, 1, 4, 4, 1, NULL, N'Incicent', N'Incicent', 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (26, 1, 1, 1, 2, NULL, N'Person Involved', N'Person Involved', 1)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (38, 1, 3, 3, 2, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (44, 1, 4, 4, 2, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (51, 1, 1, 1, 3, NULL, N'Vehicle Used', N'Vehicle Used', 1)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (57, 1, 2, 2, 3, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (69, 1, 4, 4, 3, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (76, 1, 1, 1, 4, NULL, N'Weapon Used', N'Weapon Used', 1)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (82, 1, 2, 2, 4, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (88, 1, 3, 3, 4, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (127, 1, 2, 5, 1, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (131, 1, 5, 2, 1, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (134, 1, 5, 5, 1, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (136, 1, 2, 5, 2, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (140, 1, 5, 2, 2, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (143, 1, 5, 5, 2, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (145, 1, 2, 5, 3, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (149, 1, 5, 2, 3, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (152, 1, 5, 5, 3, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (154, 1, 2, 5, 4, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (158, 1, 5, 2, 4, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (161, 1, 5, 5, 4, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (162, 1, 1, 1, 5, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (168, 1, 2, 2, 5, 5, NULL, NULL, 1)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (171, 1, 2, 5, 5, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (174, 1, 3, 3, 5, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (180, 1, 4, 4, 5, NULL, NULL, NULL, 0)
GO
INSERT [graphdb].[Relations] ([RelationID], [ViewGroupID], [SourceNodeID], [SearchNodeID], [DisplayNodeID], [RelationNodeID], [RelationEn], [RelationAr], [isActive]) VALUES (183, 1, 5, 2, 5, NULL, NULL, NULL, 0)
GO
SET IDENTITY_INSERT [graphdb].[Relations] OFF
GO
INSERT [graphdb].[RelationsData] ([ENED_B_ENED], [ARED_B_ARED], [DATE_B_DATE], [ID_B_ID], [ENTEXT_B_ENTEXT], [ARTEXT_B_ARTEXT], [ENED_R_ENED], [ARED_R_ARED], [DATE_R_DATE], [ID_R_ID], [ENTEXT_R_ENTEXT], [ARTEXT_R_ARTEXT]) VALUES (N'Character', N'Character', CAST(N'1900-01-01' AS Date), 1, N'Person 1', N'Person 1', N'Brother', N'Brother', CAST(N'1900-01-01' AS Date), 2, N'Person 2', N'Person 2')
GO
INSERT [graphdb].[RelationsData] ([ENED_B_ENED], [ARED_B_ARED], [DATE_B_DATE], [ID_B_ID], [ENTEXT_B_ENTEXT], [ARTEXT_B_ARTEXT], [ENED_R_ENED], [ARED_R_ARED], [DATE_R_DATE], [ID_R_ID], [ENTEXT_R_ENTEXT], [ARTEXT_R_ARTEXT]) VALUES (N'Character', N'Character', CAST(N'1900-01-01' AS Date), 1, N'Person 1', N'Person 1', N'Sister', N'Sister', CAST(N'1900-01-01' AS Date), 3, N'Person 3', N'Person 3')
GO
INSERT [graphdb].[RelationsData] ([ENED_B_ENED], [ARED_B_ARED], [DATE_B_DATE], [ID_B_ID], [ENTEXT_B_ENTEXT], [ARTEXT_B_ARTEXT], [ENED_R_ENED], [ARED_R_ARED], [DATE_R_DATE], [ID_R_ID], [ENTEXT_R_ENTEXT], [ARTEXT_R_ARTEXT]) VALUES (N'Character', N'Character', CAST(N'1900-01-01' AS Date), 4, N'Person 4', N'Person 4', N'Sister', N'Sister', CAST(N'1900-01-01' AS Date), 5, N'Person 5', N'Person 5')
GO
SET IDENTITY_INSERT [graphdb].[ViewColumns] ON 
GO
INSERT [graphdb].[ViewColumns] ([ViewColumnID], [ViewID], [ColumnID]) VALUES (1, 1, N'ID_A_ID')
GO
INSERT [graphdb].[ViewColumns] ([ViewColumnID], [ViewID], [ColumnID]) VALUES (2, 1, N'ID_B_ID')
GO
INSERT [graphdb].[ViewColumns] ([ViewColumnID], [ViewID], [ColumnID]) VALUES (3, 1, N'ID_C_ID')
GO
INSERT [graphdb].[ViewColumns] ([ViewColumnID], [ViewID], [ColumnID]) VALUES (4, 1, N'ID_D_ID')
GO
INSERT [graphdb].[ViewColumns] ([ViewColumnID], [ViewID], [ColumnID]) VALUES (5, 2, N'ID_B_ID')
GO
INSERT [graphdb].[ViewColumns] ([ViewColumnID], [ViewID], [ColumnID]) VALUES (6, 2, N'ID_R_ID')
GO
SET IDENTITY_INSERT [graphdb].[ViewColumns] OFF
GO
SET IDENTITY_INSERT [graphdb].[ViewGroupLists] ON 
GO
INSERT [graphdb].[ViewGroupLists] ([ViewGroupListID], [ViewGroupID], [ViewID]) VALUES (1, 1, 1)
GO
INSERT [graphdb].[ViewGroupLists] ([ViewGroupListID], [ViewGroupID], [ViewID]) VALUES (4, 1, 2)
GO
SET IDENTITY_INSERT [graphdb].[ViewGroupLists] OFF
GO
SET IDENTITY_INSERT [graphdb].[ViewGroups] ON 
GO
INSERT [graphdb].[ViewGroups] ([ViewGroupID], [ViewGroupNameEn], [ViewGroupNameAr]) VALUES (1, N'Incidents Tracking', N'Incidents Tracking')
GO
SET IDENTITY_INSERT [graphdb].[ViewGroups] OFF
GO
SET IDENTITY_INSERT [graphdb].[Views] ON 
GO
INSERT [graphdb].[Views] ([ViewID], [ViewDescriptionEn], [ViewDescriptionAr], [ViewName], [ViewDB], [ViewSchema]) VALUES (1, N'Incidents En', N'Incidents Ar', N'IncidentsData', N'IAS', N'graphdb')
GO
INSERT [graphdb].[Views] ([ViewID], [ViewDescriptionEn], [ViewDescriptionAr], [ViewName], [ViewDB], [ViewSchema]) VALUES (2, N'Relations En', N'Relations Ar', N'RelationsData', N'IAS', N'graphdb')
GO
SET IDENTITY_INSERT [graphdb].[Views] OFF
GO
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ_NodeData]    Script Date: 03/12/2025 1:44:57 AM ******/
ALTER TABLE [graphdb].[NodeData] ADD  CONSTRAINT [UQ_NodeData] UNIQUE NONCLUSTERED 
(
	[ViewGroupID] ASC,
	[NodeID] ASC,
	[NodeValueID] ASC
...
GO
/****** Object:  StoredProcedure [graphdb].[sp_GraphGenerate]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_GroupNodeList]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodeDataAutoComplete]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
    ...
    BEGIN TRY
        ...
        SET @SQL = N'
            SELECT TOP (' + CAST(@TopCount AS NVARCHAR(10)) + N')
                  nd.[NodeDataID],
                  ' + @LangColumn + N' AS [NodeValue]
            FROM [graphdb].[NodeData] AS nd
            WHERE nd.[NodeID] = @NodeID
              AND (
                    @SearchText = N'''' 
                    OR nd.[NodeValueEn] LIKE N''%'' + @SearchText + N''%''
                    OR nd.[NodeValueAr] LIKE N''%'' + @SearchText + N''%''
                  )
              AND (
                    ' + @LangColumn + N' IS NOT NULL AND LTRIM(RTRIM(' + @LangColumn + N')) <> N''''
                  )
            ORDER BY ' + @LangColumn + N';
        ';

        EXEC sp_executesql 
            @SQL,
            N'@NodeID INT, @SearchText NVARCHAR(200)',
            @NodeID = @NodeID,
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodeDataGenerate]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodesExpand]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
/*
    Pre-requisite: Create the TVP Types first if they don't exist
...
CREATE PROCEDURE [graphdb].[sp_NodesExpand]
    @ViewGroupID INT,
    @SourceNodeDataIDs [graphdb].[NodeDataIDTable] READONLY,  
...
BEGIN
    ...
    WITH RankedRelations AS (
        SELECT 
            R.*,
            ROW_NUMBER() OVER (
                PARTITION BY R.SourceNodeDataID 
                ORDER BY R.TargetNodeValueDate DESC
            ) AS RowNum
        FROM [IAS].[graphdb].[vRelationData] R
        INNER JOIN @SourceNodeDataIDs S ON R.SourceNodeDataID = S.NodeDataID
...
END
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodesGenerate]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodesSearch]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE   PROCEDURE [graphdb].[sp_NodesSearch]
    @Lang        NVARCHAR(10) = N'en-US',              -- 'en-US' or 'ar-AE'
    @NodeDataIDs [graphdb].[NodeDataIDTable] READONLY  -- TVP with NodeDataID
AS
BEGIN
    SET NOCOUNT ON;
    ...
    BEGIN TRY
        ...
        SELECT
            ...
            , N.[ColumnColor]
			,ND.[NodeValueDate]
        FROM [graphdb].[NodeData] ND
        INNER JOIN [graphdb].[Nodes] N
            ON ND.[NodeID] = N.[NodeID]
        INNER JOIN @NodeDataIDs T
            ON T.[NodeDataID] = ND.[NodeDataID]
        ORDER BY ND.[NodeDataID];
    END TRY
    BEGIN CATCH
        DECLARE @msg NVARCHAR(4000) = ERROR_MESSAGE();
        RAISERROR(@msg, 16, 1);
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodeUpdate]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_RelationDataGenerate]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_RelationsGenerate]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_RelationsList]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_RelationUpdate]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_ViewGroupNodesList]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_ViewGroupsList]    Script Date: 03/12/2025 1:44:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
