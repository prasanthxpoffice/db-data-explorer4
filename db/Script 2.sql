USE [IAS]
GO
/****** Object:  Table [graphdb].[Relations]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [graphdb].[Nodes]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[GroupNode]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [graphdb].[vRelations]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[NodeData]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [graphdb].[vNodeData]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[RelationData]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [graphdb].[vRelationData]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[ViewColumns]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[ViewGroupLists]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[ViewGroups]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[Views]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [graphdb].[sp_GraphGenerate]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_GroupNodeList]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodeDataAutoComplete]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodeDataGenerate]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
    ...
    BEGIN TRY
        ...
        ;WITH IDCols AS (
            ...
            WHERE n.GroupNodeID IS NOT NULL AND vc.ColumnID LIKE N'ID\_%\_ID' ESCAPE N'\'
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodesExpand]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
/*
-- 1. Declare the Source Nodes Table
DECLARE @NodesToExpand [graphdb].[NodeIdentityTable];

INSERT INTO @NodesToExpand (GroupNodeID, NodeValueID)
VALUES (100, 200);

-- 2. Declare the Filter Nodes Table
DECLARE @FilterNodes [graphdb].[NodeFilterTable]; 

INSERT INTO @FilterNodes (NodeID, FromDate, ToDate)
VALUES 
    (5, '2023-01-01', '2023-12-31'), -- Filter by NodeID 5 within this date range
    (10, '1900-01-01', '2099-12-31'); -- Filter by NodeID 10 with full date range

-- 3. Execute the procedure
EXEC [graphdb].[sp_NodesExpand]
    @ViewGroupID = 1,
    @SourceNodeIdentities = @NodesToExpand,
    @FilterNodes = @FilterNodes, -- Pass the filter table variable
    @MaxNeighbors = 100,
    @Lang = 'en-US';
*/
BEGIN
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodesFindPath]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
DECLARE @PathSearchNodes [graphdb].[NodeIdentityTable];

-- 2. Insert BOTH the Source and Target nodes
INSERT INTO @PathSearchNodes (GroupNodeID, NodeValueID)
VALUES 
    (100, 200), -- Source Node
    (300, 400); -- Target Node

-- 3. Execute the procedure
EXEC [graphdb].[sp_NodesFindPath]
    @ViewGroupID = 1,
    @SourceNodeIdentities = @PathSearchNodes,
    @MaxDepth = 4,
    @Lang = 'en-US';
*/
BEGIN
...
END
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodesGenerate]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodesSearch]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodeUpdate]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_RelationDataGenerate]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_RelationsGenerate]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_RelationsList]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_RelationUpdate]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_ViewGroupNodesList]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_ViewGroupsList]    Script Date: 12/5/2025 8:39:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
