USE [IAS]
GO
/****** Object:  Schema [graphdb]    Script Date: 12/9/2025 8:24:42 AM ******/
CREATE SCHEMA [graphdb]
GO
/****** Object:  UserDefinedTableType [graphdb].[NodeDataIDTable]    Script Date: 12/9/2025 8:24:42 AM ******/
...
GO
/****** Object:  UserDefinedTableType [graphdb].[NodeFilterTable]    Script Date: 12/9/2025 8:24:42 AM ******/
...
GO
/****** Object:  UserDefinedTableType [graphdb].[NodeIdentityTable]    Script Date: 12/9/2025 8:24:42 AM ******/
CREATE TYPE [graphdb].[NodeIdentityTable] AS TABLE(
	[GroupNodeID] [int] NOT NULL,
	[NodeValueID] [nvarchar](128) NOT NULL
)
GO
/****** Object:  Table [graphdb].[Relations]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [graphdb].[Nodes]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [graphdb].[Nodes](
	...
	[isDateFilterRequired] [bit] NOT NULL,
...
GO
/****** Object:  Table [graphdb].[GroupNode]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [graphdb].[vRelations]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[NodeData]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [graphdb].[vNodeData]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[RelationData]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [graphdb].[vRelationData]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[IncidentsData]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[RelationsData]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[ViewColumns]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[ViewGroupLists]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[ViewGroups]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [graphdb].[Views]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [graphdb].[Nodes] ADD  CONSTRAINT [DF_Nodes_isDateFilterRequired]  DEFAULT ((1)) FOR [isDateFilterRequired]
GO
...
GO
/****** Object:  StoredProcedure [graphdb].[sp_GraphDataGenerate]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_GraphSchemaGenerate]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_GroupNodeList]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodeDataAutoComplete]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodeDataGenerate]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodesExpand]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
    ...
    ------------------------------------------------------------
    -- 1. Materialize TVPs into temp tables with good indexes
    ------------------------------------------------------------
    -- Sources: match join (SourceGroupNodeID, SourceNodeValueID)
    CREATE TABLE #SourceNodeIdentities
    (
        GroupNodeID INT           NOT NULL,
        NodeValueID NVARCHAR(128) NOT NULL,
        CONSTRAINT PKC_Source PRIMARY KEY CLUSTERED (GroupNodeID, NodeValueID)
    );

    INSERT INTO #SourceNodeIdentities (GroupNodeID, NodeValueID)
    SELECT GroupNodeID, NodeValueID
    FROM @SourceNodeIdentities;

    -- Filters: (NodeID, FromDate, ToDate) is unique and used with BETWEEN
    CREATE TABLE #FilterNodes
    (
        NodeID   INT  NOT NULL,
        FromDate DATE NOT NULL,
        ToDate   DATE NOT NULL,
        CONSTRAINT PKC_Filter UNIQUE CLUSTERED (NodeID, FromDate, ToDate)
    );

    INSERT INTO #FilterNodes (NodeID, FromDate, ToDate)
    SELECT NodeID, FromDate, ToDate
    FROM @FilterNodes;

    ------------------------------------------------------------
    -- 2. Aggregated relations (one row per logical edge)
    ------------------------------------------------------------
    ...
    (
        SELECT
            ...
            COUNT(*)                   AS RelationCount         -- how many rows
    ...
    ------------------------------------------------------------
    -- 3. Final selection (apply @MaxNeighbors) + language logic
    ------------------------------------------------------------
    SELECT
        R.RelationDataID,
        -- Source
    ...
    OPTION (RECOMPILE);   -- important for good estimates with temp tables

    ------------------------------------------------------------
    -- 4. Cleanup
    ------------------------------------------------------------
    DROP TABLE #SourceNodeIdentities;
    DROP TABLE #FilterNodes;
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodesFindPath]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodesGenerate]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodeUpdate]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_RelationDataGenerate]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_RelationsGenerate]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_RelationsList]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_RelationUpdate]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_ViewGroupNodesList]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [graphdb].[sp_ViewGroupsList]    Script Date: 12/9/2025 8:24:42 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
